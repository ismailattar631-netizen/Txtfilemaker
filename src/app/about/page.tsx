...
import { FileText, Shield, Zap, Sparkles, Terminal, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div className="space-y-6 text-sm sm:text-base text-slate-300 leading-relaxed">
        <h2 className="text-xl font-bold text-slate-100">The Plain Text Philosophy</h2>
        ...
        <h2 className="text-xl font-bold text-slate-100">Engineering Principles</h2>
