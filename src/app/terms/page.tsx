  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 text-slate-300">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-slate-400">
        <p>
          By accessing or using <strong>TxtCraft Pro</strong>, you agree to be bound by these Terms of Service.
        </p>

        <h2 className="text-lg font-bold text-slate-100">1. Permitted Use</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-slate-100">2. Disclaimer of Warranties</h2>
        <p>
