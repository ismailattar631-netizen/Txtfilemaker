  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 text-slate-300">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-slate-400">
        <p>
          At <strong>TxtCraft Pro</strong>, we believe privacy is a fundamental human right.
          This Privacy Policy outlines how our tools handle your text files and information.
        </p>

        <h2 className="text-lg font-bold text-slate-100">1. Client-Side Data Processing</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-slate-100">2. Cookies and Analytics</h2>
        <p>
